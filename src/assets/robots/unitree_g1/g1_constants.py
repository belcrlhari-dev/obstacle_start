...
FULL_COLLISION = CollisionCfg(
  ...
  priority={r"^(left|right)_foot[1-7]_collision$": 10},  # Increased from 1 to 10
...
for a in G1_ARTICULATION.actuators:
  ...
  for n in names:
    # Increase ankle action scaling to allow more foot movement
    if "ankle" in n:
      G1_ACTION_SCALE[n] = 0.5 * e / s  # Increased from 0.25 to 0.5
    else:
