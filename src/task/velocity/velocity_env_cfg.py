...
def make_velocity_env_cfg() -> ManagerBasedRlEnvCfg:
  ...
  lidar_scan = RayCastSensorCfg(
    ...
    frame=ObjRef(type="body", name="", entity="robot"),  # Set per-robot.
    ray_alignment="yaw",
    pattern=GridPatternCfg(size=(4.0, 0.6), resolution=0.2),
    max_distance=5.0,
    exclude_parent_body=True,
    debug_vis=True,
  ...
  actor_terms = {
    ...
    "lidar_scan": ObservationTermCfg(
      func=envs_mdp.height_scan,
      params={"sensor_name": "lidar_scan"},
      noise=Unoise(n_min=-0.05, n_max=0.05),
      scale=1 / lidar_scan.max_distance,
    ),
  }
  ...
  events = {
    ...
    "foot_friction": EventTermCfg(
      ...
      params={
        ...
        "operation": "abs",
        "ranges": (2.0, 2.5),  # Further increased from (1.2, 1.6) to (2.0, 2.5) for better traction
  ...
  return ManagerBasedRlEnvCfg(
    scene=SceneCfg(
      ...
      sensors=(terrain_scan, lidar_scan),
      num_envs=1,
      extent=2.0,
    ),
